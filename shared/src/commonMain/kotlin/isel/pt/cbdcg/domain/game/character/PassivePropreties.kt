...
val PaladinBasicProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +dmg and -def, one point of each for each point of def from equipped items.", PaladinBasic)
val PaladinRareProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +hp, one point for each equipped item.", PaladinRare)
val PaladinEpicProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +hp, one point for each equipped item.", PaladinEpic)
...
val WerewolfBasicProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +dmg, one point for each point of dmg from equipped items.", WerewolfBasic)
val WerewolfRareProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +dmg, one point for each equipped item.", WerewolfRare)
...
val BerserkerBasicProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "Gains +def and -dmg, one point of each for each point of dmg from equipped items.", BerserkerBasic)
...
val NoPassiveProps = PassiveProps(PassiveType.NEUTRAL_PASSIVE, false, "There is nothing here.", NoPassive)